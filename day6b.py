...
def main(argv):
    ...
    if len(argv) == 2:
        ...
        print("Please specify a file (day6b.py [filepath])")
        return
    ...
    while repeat == False:
        ...
        memAdder(memBanks)
        cycles += 1
        for index, bank in enumerate(memBanksLog):
            if memBanks == bank:
                cycleSize = cycles - index
                repeat = True

    print("The infinitely repeating loop is {} cycles large".format(cycleSize))
