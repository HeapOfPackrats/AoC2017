...
def main():
    ...
    with open("input8.txt") as inputFile:
        regVals = dict()
        highestWhileExec = execInstructions(inputFile, regVals)

    highestReg, highestVal = findHighest(regVals)
    print("Register {} has the highest value, {}\nThe highest value recorded while executing instructions is {}".format(highestReg, highestVal, highestWhileExec))
